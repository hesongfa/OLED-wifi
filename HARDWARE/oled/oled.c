...
void ShowNormal(void)
{
	...
	for(i=0;i<3;i++)
	{
		OLED_ShowMYCN(39+i*16,6,Normal16x16,i);//测试显示中文
	}
}
...
void ShowTemperature(void)
{
	...
	for(i=0;i<2;i++)
	{
		OLED_ShowMYCN(0+i*16,2,temperature16x16,i);//测试显示中文
	}
}
...
void ShowSmartTrash(void)
{
	...
	for(i=0;i<5;i++)
	{
		OLED_ShowMYCN(25+i*16,0,smartTrash16x16,i);//测试显示中文
	}
}
...
void ShowTrashFull(void)
{
	...
	for(i=0;i<8;i++)
	{
		OLED_ShowMYCN(0+i*16,6,Chinese_full16x16,i);//测试显示中文
	}
}
